...
def create_spline(oEditor, x, y, z, Name="Polyline1", 
                                Flags="", 
                                Color="(132 132 193)", 
                                Transparency=0, 
                                PartCoordinateSystem="Global", 
    ...
    oEditor : pywin32 COMObject
        The HFSS editor in which to perform the operation
    x : array_like
        The x locations of the spline polyline vertices. Can have numeric or string elements.
    y : array_like
        The y locations of the spline polyline vertices. Can have numeric or string elements.
    z : array_like
        The z locations of the spline polyline vertices. Can have numeric or string elements.
    Name : str
        Requested name of the spline polyline
    Flags : str
        Certain flags that can be set.  See HFSS Scripting Manual for details.
    Transparency : float
        Fractional transparency of the object.  0 is opaque, 1 is transparent.
    ...
    SolveInside : bool
        Whether fields are computed inside the object.
    IsPolylineCovered : bool
        Whether the spline polyline is covered.
    IsPolylineClosed : bool
        Whether the spline polyline should be considered closed.
    TODO:  finish documentation of this function.
        
    Returns
    -------
    polyname : str
        Actual name of the spline polyline
    ...
    >>> tri = hfss.create_polyline(oEditor, [0, 1, 0], [0, 0, 1], [0, 0, 0])
    """
    # Augment the spline polyline points vector by appending the first element to 
    # the last.  This gives spline polyline points and N - 1 segments
    xv = list(x) + [list(x)[0]]
    yv = list(y) + [list(y)[0]]
    zv = list(z) + [list(z)[0]]
